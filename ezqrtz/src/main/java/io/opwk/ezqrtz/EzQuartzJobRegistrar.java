...
import io.owpk.ezqrtz.core.DefaultEzQuartzScheduleExecutor;
...
import io.owpk.ezqrtz.core.utils.QrtzUtils;
...
public record EzQuartzJobRegistrar(
    ...
    public void register(Object bean, EzCronJob ezQuartzJob, MethodHandle methodHandle) {
